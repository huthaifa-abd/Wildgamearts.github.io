(function($) {
  ...
  $(document).ready(function() {
    ...
    // fire presskit
    $("#fire-presskit").on("click", function(e) {
      e.preventDefault();
    });
    // fire devblog
    $("#fire-Devblog").on("click", function(e) {
      e.preventDefault();
    });
    // fire forums
    $("#fire-forums").on("click", function(e) {
      e.preventDefault();
    });
    // fire contact
    ...
    $("#wordrotator").wordsrotator({
      ...
      words: ['we are<br><span class="highlighter">indie studio</span>', 'we have<br><span class="highlighter">one goal</span>',
      'build the<br><span class="highlighter">best games</span>'
    ]
